...
const getAllBlogsHandler_1 = require("./routes/handlers/getAllBlogsHandler");
const createBlogHandler_1 = require("./routes/handlers/createBlogHandler");
const findBlogHandler_1 = require("./routes/handlers/findBlogHandler");
const updateBlogsHandler_1 = require("./routes/handlers/updateBlogsHandler");
const deleteBlogHandler_1 = require("./routes/handlers/deleteBlogHandler");
const deleteAllBlogsHandler_1 = require("./routes/handlers/deleteAllBlogsHandler");
...
exports.blogsRouter
    ...
    .post("/", super_admin_guard_middleware_1.superAdminGuardMiddleware, blog_input_dto_validation_1.blogValidators, input_validation_result_middleware_1.inputValidationResultMiddleware, createBlogHandler_1.createBlogHandler)
