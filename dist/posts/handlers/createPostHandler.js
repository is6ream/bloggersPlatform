...
function createPostHandler(req, res) {
  return __awaiter(this, void 0, void 0, function* () {
    const foundBlog = yield blogs_repository_1.blogsRepository.findById(
      req.body.blogId,
    );
    if (!foundBlog) {
    ...
    const dataForResponse =
      yield postRepository_1.postRepository.create(newPost);
    res.status(http_statuses_1.HttpStatus.Created).send(dataForResponse);
  });
}
